...
test_split_name_images = '../data/disent_indommain/cars3d_random_test_images.npz'
test_split_name_targets = '../data/disent_indommain/cars3d_random_test_labels.npz'

val_split_name_images = '../data/disent_indommain/cars3d_random_val_images.npz'
val_split_name_targets = '../data/disent_indommain/cars3d_random_val_labels.npz'

train_split_name_images = '../data/disent_indommain/cars3d_random_train_without_val_images.npz'
train_split_name_targets = '../data/disent_indommain/cars3d_random_train_without_val_labels.npz'
