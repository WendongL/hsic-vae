...
def _generate_training_sample(ground_truth_data, representation_function,
  ...
  # factors1 = torch.from_numpy(factors1)
  # factors2 = torch.from_numpy(factors2)
  ...
  observation1 = torch.from_numpy(observation1)
  observation2 = torch.from_numpy(observation2)
  # Compute representations based on the observations.
  representation1 = representation_function(observation1).detach().numpy()
  representation2 = representation_function(observation2).detach().numpy()
